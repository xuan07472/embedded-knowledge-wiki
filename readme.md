...
- **音视频模块**完整内容详见*子文档*：《[音视频开发](./音视频开发.md)》
...
##### 7.2 GUI框架  
###### 7.2.1 Qt框架  
**Qt模块**详见*子文档*：《[i2s模块.md<待修改为csdn网址>](https://gitee.com/langcai1943/embedded-knowledge-wiki/blob/develop/i2s%E6%A8%A1%E5%9D%97.md)》  

###### 7.2.2 uC/GUI  

7.2 传感器采集与校准  
7.3 电视节目加解扰  
7.4 键盘键值（不同国家布局、不同游戏手柄布局）  
7.5 蓝牙音响  
