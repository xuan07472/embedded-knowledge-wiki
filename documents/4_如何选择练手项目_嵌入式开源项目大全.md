...
本文档源码地址：[才鲸嵌入式 / 嵌入式知识图谱WiKi](https://gitee.com/langcai1943/embedded-knowledge-wiki/blob/develop/documents/4_%E5%A6%82%E4%BD%95%E9%80%89%E6%8B%A9%E7%BB%83%E6%89%8B%E9%A1%B9%E7%9B%AE_%E5%B5%8C%E5%85%A5%E5%BC%8F%E5%BC%80%E6%BA%90%E9%A1%B9%E7%9B%AE%E5%A4%A7%E5%85%A8.md)  
文章阅读地址：[如何选择嵌入式练手项目、嵌入式开源项目大全](https://blog.csdn.net/qq582880551/article/details/125363614)  
...
#### 2.3 嵌入式应用软件工程师可以借鉴的项目：  

* VLC、FFmpeg、QEMU、SDL、
  * XEIM 即时通讯
  * Tinyhttpd 简单的http服务器
  * SQLite 嵌入式数据库
  * MAKE、Nginx、OpenSSL、OpenGL、Chromium、VIM、Bash、Emacs、VIM、各种shell命令、glibc
  * Redis 键值对存储系统（数据库）、MySQL、GCC、Git
  * [morixinguan / MCU产品级项目收集](https://gitee.com/morixinguan/mcu-product)
  * [JayHeng/pzh-mcu-bi-weekly Public](https://github.com/JayHeng/pzh-mcu-bi-weekly)
  * [《安富莱嵌入式周报》](https://www.armbbs.cn/forum.php?mod=forumdisplay&fid=12&filter=typeid&typeid=104)
  * [stm32开源项目_最近收集的开源项目专栏(持续更新,收好车轮,方便造车)](https://blog.csdn.net/weixin_39710966/article/details/111371824)

* 磁盘管理，GParted使用C++写成,使用gtkmm提供GTK+界面。
  * MPlayer，C语言
  * SMPlayer，C++
  * [Linux下的经典软件(史上最全)](http://www.360doc.com/content/21/1228/11/3046928_1010702738.shtml)

* [c 开源软件](https://m.51sjk.com/b1b72178/)
  * [盘点14个著名的软件开源项目，你知道几个？](http://it.cha138.com/mysql/show-109758.html)
  * [【开源项目】C语言开源项目一览](https://blog.csdn.net/qxhgd/article/details/127486411)
  * [C语言开发工程师一定要熟读的5个开源项目](https://baijiahao.baidu.com/s?id=1626085347024249162)
  * [嵌入式产品级项目分享开源](https://www.eefocus.com/article/477197.html)
  * [精选十款优秀的Linux应用软件](http://www.hzhcontrols.com/new-556982.html)
  * [最受IT公司欢迎的30款开源软件](https://blog.csdn.net/emprere/article/details/125592056)


* 结论：网上很难搜到著名的、完整的嵌入式商用开源项目
...
### 4) 如何寻找嵌入式项目和行业内的技术信息：  

* 前言：如果单是查找单片机或嵌入式软件相关的技术信息，很多在CSDN博客中就能找到，但是CSDN不好的一点就是没有嵌入式内容的分类，和各个行业里的具体运用，要查找这些内容则必须去集成电路IC、硬件和电子元器件相关的网站。
  * 因为电子元器件的采购是一个广阔的市场，所以这类网站里能得到很多广告费用，而收入一多，想要参与进来的公司也越多，所以这类网站中做的好的也有很多；我列举了一些常用的，如果有漏掉的请见谅。
  * 常用的嵌入式细分行业相关的博客或门户网站有：
    * [elecfans 电子发烧友](https://www.elecfans.com/)，[电子发烧友论坛](https://bbs.elecfans.com/)
    * [21ic电子网](https://www.21ic.com/)，[21ic电子技术论坛](https://bbs.21ic.com/)
    * [eefocus 与非网](https://www.eefocus.com/)
    * [eccn 中电网](http://www.eccn.com/)，[中国电子技术网论坛](http://bbs.eccn.com/)
    * [EEWorld 电子工程世界](http://www.eeworld.com.cn/)，[eeworld论坛](http://bbs.eeworld.com.cn/)
    * [EDN China 电子技术设计](https://www.ednchina.com/)，[面包板社区](https://mbb.eet-china.com/)
    * [eetop 易特创芯论坛](https://bbs.eetop.cn/)
    * [阿莫电子论坛](https://www.amobbs.com/index.php)
    * [eepw 电子产品世界](http://www.eepw.com.cn/)，[电子产品世界论坛](http://forum.eepw.com.cn/)
  
<center>表1各网站中嵌入式行业相关分类 </center>

|网站名称|技术分类|行业分类|
|---|---|---|
|elecfans 电子发烧友|可编程逻辑、MEMS/传感技术、嵌入式技术、模拟技术、控制/MCU、处理器/DSP、存储技术、EMI设计、接口/总线/驱动、EDA/IC设计、PCB设计、harmonyos、Type C、NB-IoT、LoRa、5G | 电源/新能源、测量仪表、制造/封装、RF/无线、光电显示、连接器、LEDs、汽车电子、医疗电子、人工智能、可穿戴设备、军用/航空电子、工业控制、触控感测、智能电网、音视频及家电、通信网络、机器人、vr ar 虚拟现实、移动通信、>便携设备、物联网、区块链、蓝牙5、激光雷达、无线充电、快充技术、能源收集、电机控制|
|21IC电子网|通信技术、显示光电、单片机、测试测量、智能硬件、物联网、模拟电源、嵌入式、新基建、电路图、中国芯、开发板|汽车电子、消费电子、工业控制、医疗电子|
|eefocus 与非网|可编程逻辑、MEMS/传感技术、嵌入式系统、模拟/电源、射频/微波、测试测量、控制器/处理器、EDA/PCB、基础器件|汽车电子、人工智能、工业电子、通信/网络、消费电子|
|eccn 中电网|嵌入式、模拟设计、电源管理、MCU、DSP、FPGA、RFID/RF、传感器、测试测量、逻辑电路、数据转换、存储器、LED|消费电子、照明、物联网、智能能源、医疗保健、智能城市、电机驱动与控制、工业以太网、汽车电子、通信、无线基站、电源管理、智能电网、工业控制、计算机与多媒体|
|EEWorld 电子工程世界|嵌入式、模拟电子、单片机、电源管理、传感器、半导体|工业控制、物联网、汽车电子、网络通信、医疗电子、手机便携、测试测量、安防电子、家用电子、机器人、新能源|
|EDN China 电子技术设计|模拟/混合信号、嵌入式系统、处理器/DSP、测试与测量、电源管理、通信、PCB设计、EDA/IP/IC设计、FPGA、物联网、人工智能、创新/创客/DIY|医疗电子、消费电子、汽车电子、工业电子、手机设计|
|eetop 易特创芯论坛|开源硬件、PCB、嵌入式、IC设计|汽车电子、医疗电子、工业控制、电测仪表|
|阿莫电子论坛|单片机、嵌入式|一些开源项目|
|eepw 电子产品世界|嵌入式系统、元件/连接器、EDA/PCB、模拟技术、物联网与传感器|电源与新能源、安防与国防、汽车电子、消费电子、工控自动化、医疗电子、测试测量、手机与无线通信、光电显示、网络与存储、智能计算|
...
6) 机械行业国家标准目录大全，中国国家标准目录[GB、GBT]，电子工业标准目录总汇：[国家级的电子产品](https://www.antpedia.com/standard/sp/354181.html) [国内最新国家标准目录(电工电子行业)](https://www.docin.com/p-312641125.html)  
